(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (markdown-mode htmlize company golden-ratio yaml-mode tide flycheck web-mode dashboard linum-relative powerline smex auto-complete magit avy general use-package))))
(custom-set-faces
